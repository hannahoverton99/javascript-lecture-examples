...
for (i =0; i < obiGreeting.length; i++){
...
while (currDistance> totalDistance){
	console.log(`Still speeding dangerously close to the black hole cluster- ${currDistance} to go!`);
...
} console.log("You're really close! Find #2187!");
